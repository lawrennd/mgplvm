function f = mgplvmPointObjective(x, model, y)

% MGPLVMPOINTOBJECTIVE Wrapper function for objective of a single point in latent space and the output location..
% FORMAT
...
% 
% SEEALSO : mgplvmCreate, mgplvmPointLogLikelihood, mgplvmOptimisePoint
%
% COPYRIGHT : Neil D. Lawrence, 2006, 2016

% FGPLVM

f = - mgplvmPointLogLikelihood(model, x, y);
